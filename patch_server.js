...
const createOrderRegex = /async function createOrder\(userId, amount, upi, userObj = null, overrideAmount = null, precisePayableAmount = null\) \{[\s\S]*?return \{ activeWithdrawal: activeWithdrawal, p2pOrder: p2pOrder \};\n\s*\}\n\s*\} catch \(e\) \{[\s\S]*?return null;\n\s*\}\n\}/;
s = s.replace(createOrderRegex, `async function createOrder(userId, amount, upi, userObj = null, overrideAmount = null, precisePayableAmount = null) {
